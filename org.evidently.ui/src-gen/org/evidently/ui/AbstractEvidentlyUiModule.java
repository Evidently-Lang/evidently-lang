...
import org.evidently.ide.contentassist.antlr.PartialEvidentlyContentAssistParser;
import org.evidently.ide.contentassist.antlr.internal.InternalEvidentlyLexer;
import org.evidently.ui.contentassist.EvidentlyProposalProvider;
import org.evidently.ui.labeling.EvidentlyDescriptionLabelProvider;
import org.evidently.ui.labeling.EvidentlyLabelProvider;
import org.evidently.ui.outline.EvidentlyOutlineTreeProvider;
import org.evidently.ui.quickfix.EvidentlyQuickfixProvider;

/**
 * Manual modifications go to {@link EvidentlyUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractEvidentlyUiModule extends DefaultXbaseUiModule {

	public AbstractEvidentlyUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.evidently.parser.antlr.internal.InternalEvidentlyLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalEvidentlyLexer.class).toProvider(LexerProvider.create(InternalEvidentlyLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return EvidentlyLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(EvidentlyDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return EvidentlyOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return EvidentlyQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return EvidentlyProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialEvidentlyContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Evidently Compare");
	}
